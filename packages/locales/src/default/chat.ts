export default {
  ...
  'sharePage.error.agent.notFound.subtitle': 'This agent share does not exist or has been removed.',
  'sharePage.error.agent.notFound.title': 'Agent Not Found',
  'sharePage.error.agent.unauthorized.subtitle': 'Please sign in to view this shared agent.',
